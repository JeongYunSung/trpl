...
//! I/O는 AsyncRead와 AsyncWriter 트레잇을 구현하며, 종종 TcpStream, File, Stdout도 구현한다.
//! Tokio은 std I/O과 비슷한 async I/O를 제공한다 ex. copy

use tokio::fs::File;
use tokio::io::{self, AsyncReadExt, AsyncWriteExt};

/// AsyncRead, AsyncWriet는 사용하기 쉬운 비동기 I/O 바이트 스트림을 제공한다.
/// 또한 이들의 metohd는 직접적으로 호출되진 않고 Future에서 poll을 통해
